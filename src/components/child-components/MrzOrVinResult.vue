...
export default defineComponent ({
    setup() {
        ...
        const isCopied = ref(false) as Ref<Boolean>;
                ...
                <div class="middle-area">
                    ...
                    <div class="content-main" style={{padding: runtimeMode.value === 'mrz' ? '10px 10px 0 30px' : '10px 10px 0 17px'}}>
                        <div class="top-info-web">
                            ...
                            <div class="result-copy-web" onClick={ copyResults }>{isCopied.value ? 'Copied' : 'Copy Result'}</div>
                        </div>
                        <div class="result-copy-mobile" onClick={ copyResults }>{isCopied.value ? 'Copied' : 'Copy Result'}</div>
