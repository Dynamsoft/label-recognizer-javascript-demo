...
export default defineComponent({
    setup() {
        ...
        watch(modeSelected, async () => {
            if (!cameraIsExists.value) {
                ...
                if (recognizer.value) {
                    ...
                    console.log(modeSelected.value);
        ...
        /* const switchSettingList = () => {
            bShowSettingList.value = !bShowSettingList.value;
            bShowModeList.value = false;
        } */
            ...
            <div class="content" onClick={closeList}>
                ...
                </ul>
                {
                    ...
                    /* <div class="setting-area" onClick={switchSettingList}>
                        <svg
                                style={{
                                    stroke: bShowSettingList.value ?  '#FE8E14' : 'rgb(204, 204, 204)',
                                }}
                                viewBox="0 0 19 19"
                                >
                        ...
                        <div class="scan-settings" style={{color: bShowSettingList.value ? '#FE8E14' : 'rgb(204, 204, 204)'}}>
                            <span style="vertical-align: middle;">Scan Settings</span>
                            <a-spin size="small" spinning={isShowLoading.value} style="margin-left: 5px;"/>
                        </div>
                    </div>
                    <div class="setting" v-show={bShowSettingList.value}>
                        ...
                        <div class="isPlaySound">
                            ...
                            <div class="options" style="margin-left: -2px">
                                <div class={{'sound-play': true, 'selected': bNeedPlaySound.value}} style="text-align: center" onClick={switchSoundPlay}>Play</div>
                                <div class={{'sound-not-play': true, 'selected': !bNeedPlaySound.value}} style="text-align: center" onClick={switchSoundPlay}>Don't Play</div>
                            </div>
                        </div>
                    </div> */
                    // #endregion
